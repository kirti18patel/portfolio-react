    ...
    <section className="my-5 skills flex-space-between">
        <div className="skills-description">
          ...
          <p>I started my professional journey in web development with startups and collaborated with talented people to create web products with creative and smart thinking. 
            <br></br><br></br>I can efficiently work on the front-end using HTML, CSS, JS, React, and other libraries. Along with this, I can also work on the back-end using Nodejs, MySQL, and NoSQL ( MongoDB ). In the rear, I possess Full-stack development skills and experiences.
