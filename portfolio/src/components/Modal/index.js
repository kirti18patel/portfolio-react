        ...
        <div className="modalContainer">
            ...
            <div className="project-info flex-center-column">
                <div className="project-img flex-center">
                    <a href={deployed} className="flex-center decoration-none-white" target="_blank">
                ...
                <div className="project-description text-center">
                    <p>{description}</p>
                    <br></br>
                    <a href={github} className="repo-link decoration-none-white text-center" target="_blank"><span></span><i className="fa fa-github"></i> Source Code</a>
                </div>
            </div>
        </div>
      </div>
